...
class Cifar10Data(Dataset):
  ...
  def __init__(self, subset):
    super(Cifar10Data, self).__init__('cifar10', subset)
  ...
  def download_message(self):
    ...
    print('Failed to find any cifar10 %s files'% self.subset)
    print('')
    print('If you have already downloaded and processed the data, then make '
          'sure to set --data_dir to point to the directory containing the '
          'location of the sharded TFRecords.\n')
    print('If you have not downloaded and prepared the cifar10 data in the '

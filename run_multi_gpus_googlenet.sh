...
WEIGHT_DECAY=0.00004 # default - alexnet/vgg_a/vgg_16:0.0005, inception_v3:0.00004, cifar10_alexnet:0.004
DROPOUT_KEEP_PROB=0.8 # The probability to keep in dropout
MOMENTUM=0.9
LR_DECAY_FACTOR=0.96 # learning rate decay factor
SIZE_TO_BINARIZE=1 # the min size of variable to enable binarizing. 1 means binarizing all variables when GRAD_BITS=1
TRAIN_BATCH_SIZE=32 # total batch size
VAL_BATCH_SIZE=25 # set smaller to avoid OOM
NUM_EPOCHS_PER_DECAY=8 # per decay learning rate
MAX_STEPS=10000000

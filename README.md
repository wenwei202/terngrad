...
# Introduction
The implementations of quantization and de-quantization operators are now available in [Caffe2/Pytorch 1.0](https://github.com/pytorch/pytorch/blob/master/caffe2/operators/fused_rowwise_random_quantization_ops.cc). TernGrad is landed into Facebook AI platform in production to overcome communication bottleneck in large-scale training.
